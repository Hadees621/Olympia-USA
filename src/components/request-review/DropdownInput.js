...
function DropdownInput({
  ...
  const [selectedOption, setSelectedOption] = useState(""); // Initialize selectedOption with an empty string
  ...
  const handleChange = (e) => {
    setSelectedOption(e.target.value); // Update selectedOption with the value of the selected option
  };
  ...
  return (
    <div className={`flex flex-col ${width} my-1`}>
      ...
      <select
        ...
        onChange={handleChange} // Use handleChange function to update selectedOption
        onBlur={handleBlur}
      >
