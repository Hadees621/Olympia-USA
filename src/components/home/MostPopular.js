            ...
            <div className='flex items-center justify-center border-t border-black'>
                <div className='flex'>
                    ...
                    <div className='relative w-[700px]'>
                        <Image src="/assests/Banners/AuthorBanner.png" width={700} height={320} alt="About Section Image" />
                        <div className="absolute top-8 left-6 p-4 space-y-2 text-[#BFE0D9] text-[13px]">
                            <p className="">Featured author</p>
                            <p className="text-white text-3xl ">Legends of Erin: Dawn of <br /> Boyhood’s Fire</p>
                            <p className="">Meadow Griffin</p>
                            <p className="">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed <br />
                                diam nonummy nibh euismod tincidunt ut laoreet dolore <br />
                                magna tation ullamcorper suscipit loullamcorper suscipit lo. <br />
