  ...
  return (
    <div className="font-open-sans lg:max-w-[800px] xl:max-w-[1000px] 2xl:max-w-[1400px] mx-auto">
      ...
      <div className="space-y-5 px-10 leading-8 font-medium py-10 lg:max-w-[700px] xl:max-w-[800px] 2xl:max-w-[1000px] mx-auto llg:mb-40">
        ...
        <h1 className="font-bold text-[13px] lg:text-[20px] lg:py-4">
          {" "}
          CHARITIES AND INITIATIVES{" "}
        </h1>
        <div className="space-y-6 lg:space-y-4 leading-9 mb-32">
          <p>
        ...
        <div className="pt-44 bg-[#F9F7F6] p-6">
          <img
            src="/assests/Corporate Social Responsibilities/Asset 2 (1).png"
            className="w-full"
            alt="Corporate Social Responsibilities"
          />
          <p className="font-bold text-[15px] py-3">LOVE FOR ALL</p>
          <div className="space-y-6 lg:space-y-4">
            <p>
              ...
              publishing teams, we want to ensure the creators of our books
              truly represent the diversity in gender, age, sexuality and
              ethnicity and each member has their story which makes the Olympia
              family even more united and beautiful.
            </p>
            <p>
        ...
        <div className="pt-44">
          <img
            ...
            alt="Corporate Social Responsibilities"
          />
          <p className="font-semibold text-[11px] lg:text-[10px]">
        ...
        <div>
          <p className="font-bold text-[11px] lg:text-[10px]">
            100% SUSTAINABLE SOURCING
          </p>
          <p>
            All of the paper that we use to make books is sustainably sourced
            and is Forest Stewardship Council® (FSC®) certified. The FSC is one
            of the only wood certification schemes endorsed by green charities
            such as Greenpeace and the WWF. They also support biodiversity, safe
            guarding forests and local communities. As they say, “Forests for
            all, forever”. Our books are also printed with Carbon Captured
            Paper. Carbon Capture is a mechanism for offsetting the carbon
            produced in the production and distribution of paper through the
            purchase of 'credits'. These then translate into money which is
            given to the Woodland Trust, who use it to plant trees which absorb
        ...
        <div>
          ...
          <p>
            ...
            manuscript by post. We try to revise and read proofs electronically
            when-ever possible, and in general communicate by phone and email
            rather than sending physical letters. These small changes in our
            day-to-day lives do add up and help us to become a forward thinking,
            independent publishing house. Every day we learn something new;
            there is certainly room for improvement and we continue our efforts
            to ensure we reduce our environmental impact by making improvements
            through our entire supply chain and working with suppliers who are
            taking measures to manage their environmental impact.
          </p>
        </div>

        <div>
          <p className="font-bold text-[11px] lg:text-[10px]">RECYCLING</p>
          <p>
            ...
            always encouraged in office and effective green ideas are rewarded.
            Every year we work as hard as we can to reduce our carbon footprint.
          </p>
        </div>
      </div>
    </div>
