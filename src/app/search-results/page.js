    ...
    <div className="w-full flex justify-center">
      <div className="lg:max-w-[850px] xl:max-w-[1400px] 2xl:max-w-[1600px]">
        <div className="bg-[#FAFAFA] p-7 my-6 mx-5 lg:mx-0">
          <h1 className="font-semibold text-[#505050] text-[28px]">Search results</h1>
        </div>
        <div className="flex flex-col font-semibold py-8">
          ...
          <p className="font-bold text-center lg:text-start my-8 lg:hidden">(6) Books</p>
          <p className="font-semibold text-center lg:text-start mt-10 hidden lg:block text-xl">Books(6)</p>
        </div>
        ...
        <p className="font-bold text-center lg:text-start my-8 lg:hidden">(6) Books</p>
        <p className="font-semibold text-center lg:text-start mt-24 hidden lg:block text-xl">Authors(6)</p>
