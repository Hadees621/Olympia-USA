...
const page = () => {
  return (
    <div className="font-open-sans">
      ...
      <div className="space-y-5 px-10 leading-8 font-medium py-10">
        ...
        <h1 className="font-bold text-[15px]"> TERMS AND CONDITIONS </h1>
        ...
        <div>
          ...
          <p>
            ...
            All software used on this Site and all content contained within the
            Site (site design, graphics, text, video, audio, copy) is property
            of Olympia Publishers Limited and is protected by international
            copyright laws.
          </p>
          <p>
            The advantage to yourself is that you will be able to obtain access
            to the material on this website, free of charge, and to do so you
            will not have to register any details about yourself which you can
            imagine is an advantage. However – should you wish to purchase or
            actually to order anything – we do require you to register so that
            you are enabled to receive from us the goods you want.
          </p>
          <p>
            We try to ensure that our content and information is as accurate as
            possible. However, we cannot guarantee that the books themselves,
            nor any of the content or other materials provided on our website
            are accurate, complete or guaranteed regarding warranties,
            conditions of satisfactory quality and appropriateness for certain
            purposes. We reserve the right to monitor the use of the site in
            accordance with any particular law so as to protect the rights of
            other users and maintain the website
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Should we, as a result of our negligence, by any chance do anything
            which causes death or personal injury, then we cannot exclude our
            liability to you.
          </p>
          <p>
            We provide the information on this website in good faith and without
            warranties, which are either expressed or implied, including but not
            limited to the implied warranties of fitness, satisfactory quality,
            or non-infringement. To enable you to find any restrictions,
            limitations etc. you should check your own local laws regarding the
            access to, browsing of, or download ing of any specific material,
            text, images, data, either video or audio from a website. The
            following is what we are not responsible for:
          </p>
          <p>
            We can neither be held responsible for any loss, claim, damage, both
            indirect or as a consequence of such loss, etc.
          </p>
        </div>

        <h1 className="font-bold text-[15px]"> POLICIES AND COOKIES</h1>

        <div>
          <p className="font-semibold text-[12px]">USER INFORMATION:</p>
          <p>
        ...
        <div>
          <p className="font-semibold text-[12px]">E-MAILS:</p>
          <p>
        ...
        <div>
          <p className="font-semibold text-[12px]">OUR AIMS:</p>
          <p>
