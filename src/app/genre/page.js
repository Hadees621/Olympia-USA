...
export default function Page() {
  ...
  const [showFilterDropdown, setShowFilterDropdown] = useState(false); // State to control Filter By dropdown visibility
    ...
    <div className="px-4">
      ...
      <div className="lg:max-w-[800px] xl:max-w-[1100px] 2xl:max-w-[1600px] mx-auto hidden lg:block">
        <div className="flex items-center p-8 gap-12 font-semibold text-[12px] xl:text-[15px] 2xl:text-[18px]">
          <div className="w-1/5">
            <div
              className="flex items-center py-4 gap-3 cursor-pointer"
              onClick={toggleFilterDropdown}
            >
              <h1>Filter by</h1> {/* Changed the text to "Filter by" */}
              <svg
            ...
            {showFilterDropdown && <FilterByDropdown />}{" "}
            {/* Show the Filter By dropdown when showFilterDropdown is true */}
          </div>
          <div className="w-4/5">
            <div className="flex justify-between border-y border-gray-300">
              ...
              <div className="relative">
                <button
                  onClick={() => setShowSortOptions(!ShowFilterOptions)}
